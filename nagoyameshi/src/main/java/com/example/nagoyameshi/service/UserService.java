...
public class UserService {
   ...
   public User createUser(SignupForm signupForm) {
       ...
       return userRepository.save(user);// DBへの保存命令
   }
   ...
   public void updateUser(UserEditForm userEditForm, User user) {
       ...
       userRepository.save(user);	// DBへの保存命令   
   }

   //UserエンティティのstripeCustomerIdフィールドに顧客IDをセットしたあと保存する。
   @Transactional
   ...
   public void updateRole(User user, String roleName) {
	 ...
	 //roleName と同じ名前の Role をデータベースから探す
